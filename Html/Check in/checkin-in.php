    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          <a class="navbar-brand" href="../UI_main.html">&nbsp;&nbsp;HOTEL</a>
    ...
    <div class="row content">
      ...
      <div class="container col-md-offset-2">
        ...
        <form class="row g-3 needs-validation" novalidate>
          ...
          <br>
          <br>
          <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Check in</button>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">ยืนยันการ Check in </h4>
                </div>
                <div class="modal-body">
                  <p>ระบบทำการบันทึกข้อมูลของลูกค้า</p>
